...
export interface ChangeJson {
    /** Key-value pairs representing state of dataList before the change.
     * If `fieldMask` is set, then only fields that changed are present in `before`.
     */
    before?: any;
    /** Key-value pairs representing state of dataList after the change. */
    after?: any;
...
export interface Runnable<T> {
    run: (dataList: T, context?: EventContext) => PromiseLike<any> | any;
}
/**
