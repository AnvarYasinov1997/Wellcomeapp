...
/**
 * Registers a Cloud Function to handle analytics dataList.
 *
...
/**
 * Interface representing the user who triggered the dataList.
 */
export declare class UserDimensions {
    ...
    /** App information. */
    appInfo?: AppInfo;
    /** Information regarding the bundle in which these dataList were uploaded. */
...
/**
 * Interface representing the device that triggered these Firebase Analytics dataList.
 */
export interface DeviceInfo {
    ...
    deviceModel?: string;
    /**
     * Device OS version when dataList capture ended.
     * Example: "4.4.2"
     */
    ...
    /**
     * The time zone of the device when dataList was uploaded, as seconds skew from UTC.
...
/**
 * Interface representing the geographic origin of the dataList.
 */
...
/**
 * Interface representing the application that triggered these dataList.
 */
...
/**
 * Interface representing the bundle in which these dataList were uploaded.
 */
