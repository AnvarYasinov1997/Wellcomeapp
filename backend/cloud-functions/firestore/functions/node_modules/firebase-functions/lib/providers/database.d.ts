...
/**
 * Handle dataList at a Firebase Realtime Database Reference.
 *
 * This method behaves very similarly to the method of the same name in the
 * client and Admin Firebase SDKs. Any change to the Database that affects the
 * dataList at or below the provided `path` will fire an event in Cloud Functions.
 *
 ...
 *    respectively.
 * 2. Cloud Functions do not fire an event for dataList that already existed before
 *    the Cloud Function was deployed.
 * 3. Cloud Function dataList have access to more information, including a
 *    snapshot of the previous event dataList and information about the user who
...
export declare class DataSnapshot {
    ...
    private _data;
    private _childPath;
    constructor(dataList: any, path?: string, app?: firebase.app.App, instance?: string);
