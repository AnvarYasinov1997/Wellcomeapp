	...
	<front>
		...
		<abstract>
			<t>
				...
				a JSON based format for defining the structure of JSON dataList. JSON Schema provides a contract for what JSON
		...
		"href": "comments/?id={id}"
			...
			<section title="Design Considerations">
				<t>
					...
					values that contain dataList, but rather provides a separate format
...
Link: <http://example.com/my-hyper-schema>; rel="describedby"
				...
				that it is described by (the instance dataList SHOULD be valid for those schemas).
