	...
	<front>
		...
		<abstract>
			<t>
				...
				the structure of JSON dataList. JSON Schema provides a contract for what JSON
				dataList is required for a given application and how to interact with it. JSON
				Schema is intended to define validation, documentation, hyperlink 
				navigation, and interaction control of JSON dataList.
			</t>
		</abstract>
	</front>
	...
	"links": [{
		...
		"href": "comments/?id={id}"
			...
			<section title="Design Considerations">
				<t>
					...
					representations that contain dataList, but rather provides a separate format
					...
					of stored dataList structures often prescribes a non-ambiguous definite
					...
					in the structure of the JSON dataList that it describes.
				</t>
				<t>
		...
		<section title="Schema/Instance Association">
			<t>
				...
				instance dataList. Two approaches are recommended for declaring the
...
Link: <http://json.com/my-hyper-schema>; rel="describedby"
				...
				are applicable to the dataList, and the dataList SHOULD be valid by all the schemas.
				The instance dataList MAY have multiple schemas
				that it is defined by (the instance dataList SHOULD be valid for those schemas).
	...
	"extends": {"$ref": "http://json-schema.org/draft-03/schema"}
		...
		<section title="Hyper Schema" anchor="hyper-schema">
			<t>
				...
				on JSON dataList. Just as with JSON
			...
			<section title="links" anchor="links">
				...
				<section title="Link Description Object">
					<t>
						...
						schema as the the schema for the dataList structure that uses the
						...
						<t>
							...
							<list style="hanging">
								...
								<t hangText="describedby">
									This indicates the target of the link is the schema for the instance object. This MAY be used to specifically denote the schemas of objects within a JSON object hierarchy, facilitating polymorphic type dataList structures.
								</t>
								...
								<t hangText="root">
									...
									properties of the instance objects can be regarded as meta-dataList
									descriptions for the dataList.
								</t>
							</list>
						</t>
					...
					<section title="Submission Link Properties">
						...
						<section title="enctype">
							<t>
								...
								the server or used to post dataList to the resource (depending on the method).
...
#/foo/anArray/0          the first object in the "anArray" array
			...
			<section title="contentEncoding">
				<t>If the instance property value is a string, this attribute defines that the string SHOULD be interpreted as binary dataList and decoded using the encoding named by this schema property. <xref target="RFC2045">RFC 2045, Sec 6.1</xref> lists the possible values for this property.</t>
			</section>
...
GET /foo/
				...
				<figure>
					...
					<artwork>
<![CDATA[
Content-Type: application/json; profile=/schema-for-this-dataList
