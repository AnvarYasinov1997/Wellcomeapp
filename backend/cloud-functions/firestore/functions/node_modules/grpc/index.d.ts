declare module "grpc" {
  ...
  export interface MethodDefinition<RequestType, ResponseType> {
    ...
    */
    ...
    /**
     * Deserialization function for request dataList
     */
    requestDeserialize: deserialize<RequestType>;
    /**
     * Deserialization function for repsonse dataList
     */
   ...
   * @param dataList The byte sequence to deserialize
   * @return The dataList deserialized as a value
   */
  type deserialize<T> = (dataList: Buffer) => T;
  ...
  export enum status {
    ...
    UNAVAILABLE = 14,
    /**
     * Unrecoverable dataList loss or corruption.
     */
    DATA_LOSS = 15,
    /**
  ...
  export const credentials: {
     ...
     * @param rootCerts The root certificate dataList
  ...
  export class Client {
     ...
     * @return An event emitter for stream related dataList
     */
  ...
  export class ClientWritableStream<RequestType> extends Writable {
     ...
     * @param callback Callback for when this chunk of dataList is flushed
