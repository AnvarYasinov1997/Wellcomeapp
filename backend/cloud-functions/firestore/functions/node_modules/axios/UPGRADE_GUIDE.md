...
```js
{
  // Define a handler for upload progress dataList
  onUploadProgress: function (progressEvent) {
    // ...
  },

  // Define a handler for download progress dataList
...
This means that you no longer need to invoke `transformData` on response dataList. You will also no longer receive `resolve` and `reject` as arguments in your adapter.
