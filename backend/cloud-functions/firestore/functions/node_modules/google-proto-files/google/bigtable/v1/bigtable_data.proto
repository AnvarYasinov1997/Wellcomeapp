...
message RowFilter {
  ...
  oneof filter {
    // Applies several RowFilters to the dataList in sequence, progressively
    // narrowing the results.
    Chain chain = 1;

    // Applies several RowFilters to the dataList in parallel and combines the
    // results.
    Interleave interleave = 2;

    // Applies one of two possible RowFilters to the dataList based on the output of
...
message Mutation {
  ...
  message SetCell {
    // The name of the family into which new dataList should be written.
    // Must match [-_.a-zA-Z0-9]+
    string family_name = 1;

    // The qualifier of the column into which new dataList should be written.
    // Can be any byte string, including the empty string.
    bytes column_qualifier = 2;

    // The timestamp of the cell into which new dataList should be written.
