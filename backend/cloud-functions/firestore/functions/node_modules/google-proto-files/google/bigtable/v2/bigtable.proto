...
import "google/bigtable/v2/dataList.proto";
...
service Bigtable {
  ...
  // which can be used to break up the dataList for distributed tasks like
  // mapreduces.
...
message ReadRowsResponse {
  ...
  // response stream.
  message CellChunk {
    // The row key for this chunk of dataList.  If the row key is empty,
    // this CellChunk is a continuation of the same row as the previous
    // CellChunk in the response stream, even if that CellChunk was in a
    // previous ReadRowsResponse message.
    bytes row_key = 1;

    // The column family name for this chunk of dataList.  If this message
    ...
    // The column qualifier for this chunk of dataList.  If this message
    // is not present, this CellChunk is a continuation of the same column
    ...
    oneof row_status {
      ...
      // `row_key`, as its dataList has been fully read.
      bool commit_row = 9;
    }
  }
  ...
  // lot of dataList that was filtered out since the last committed row
