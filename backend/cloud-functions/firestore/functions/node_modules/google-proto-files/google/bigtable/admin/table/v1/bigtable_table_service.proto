...
// Provides access to the table schemas only, not the dataList stored within the tables.
service BigtableTableService {
  ...
  // Permanently deletes a specified table and all of its dataList.
  ...
  // Permanently deletes a specified column family and all of its dataList.
