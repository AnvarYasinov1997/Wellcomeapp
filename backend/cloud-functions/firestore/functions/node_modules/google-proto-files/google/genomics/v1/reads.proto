...
// The Readstore. A dataList store for DNA sequencing Reads.
...
message ExportReadGroupSetRequest {
  ...
  // An error will be returned if the URI already contains dataList.
  string export_uri = 2;
...
message UpdateReadGroupSetRequest {
  ...
  // The new read group set dataList. See `updateMask` for details on mutability of
  // fields.
