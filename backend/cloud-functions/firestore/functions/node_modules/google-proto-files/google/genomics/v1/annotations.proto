...
service AnnotationServiceV1 {
  ...
  // lesser dataList issues, when possible an error will be isolated to the
...
message Annotation {
  ...
  // The dataList type for this annotation. Must match the containing annotation
  // set's type.
...
message ExternalId {
  // The name of the source of this dataList.
  string source_name = 1;

  // The id used by the source of this dataList.
  string id = 2;
}
...
message BatchCreateAnnotationsRequest {
  ...
  // provided, duplicated requests may result in duplicated dataList. For a given
