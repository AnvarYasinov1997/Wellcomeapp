...
message Variable {
  ...
  // expression. The rest of breakpoint dataList still remains valid. Variables
...
message Breakpoint {
  ...
  enum Action {
    ...
    // The dataList is only captured once. After that the breakpoint is set
    // in a final state.
    CAPTURE = 0;
  ...
  // the stack, can have all of its dataList stored once in this table.  The
