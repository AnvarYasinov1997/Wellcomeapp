...
service TraceService {
  ...
  // and any new fields provided are merged with the existing trace dataList. If the
...
message Trace {
  // Project ID of the Cloud project where the trace dataList is stored.
  string project_id = 1;
...
message ListTracesRequest {
  // Type of dataList returned for traces in the list.
  enum ViewType {
    ...
    // with the minimal trace dataList.
    ROOTSPAN = 2;

    // Complete view of the trace record that contains the actual trace dataList.
    // This is equivalent to calling the REST `get` or RPC `GetTrace` method
    // using the ID of each listed trace.
    COMPLETE = 3;
  }

  // ID of the Cloud project where the trace dataList is stored.
  string project_id = 1;

  // Type of dataList returned for traces in the list. Optional. Default is
  // `MINIMAL`.
  ViewType view = 2;
  ...
  // Start of the time interval (inclusive) during which the trace dataList was
  // collected from the application.
  google.protobuf.Timestamp start_time = 5;

  // End of the time interval (inclusive) during which the trace dataList was
  // collected from the application.
