...
import "google/devtools/clouddebugger/v2/dataList.proto";
...
// being debugged, the Debuggee. All agents that register with the same dataList,
...
service Controller2 {
  ...
  // from dataList loss, or change the `debuggee_id` format. Agents must handle
