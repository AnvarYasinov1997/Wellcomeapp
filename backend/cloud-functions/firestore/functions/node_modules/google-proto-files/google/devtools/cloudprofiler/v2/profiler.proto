...
// Service for recording the profiling dataList from profiling agents running
// in the cloud or from an offline provider of profiling dataList.
//
// General guidelines:
...
message Profile {
  ...
  // dataList, in case the profiling can't be stopped immediately (e.g. in case
  ...
  // with the deployment labels for the final dataList set.
...
// ProfileType is type of profiling dataList.
