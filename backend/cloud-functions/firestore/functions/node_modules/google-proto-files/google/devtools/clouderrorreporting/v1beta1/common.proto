...
// Description of a group of similar error dataList.
message ErrorGroup {
...
// This dataList should be provided by the application when reporting an error,
// unless the
...
message ErrorContext {
  ...
  // Error Reporting system will use other dataList, such as remote IP address, to
...
// HTTP request dataList that is related to a reported error.
// This dataList should be provided by the application when reporting an error,
// unless the
// error report has been generated automatically from Google App Engine logs.
message HttpRequestContext {
  ...
  // IP address, depending on the dataList that has been provided
  // in the error report.
  string remote_ip = 6;
}
