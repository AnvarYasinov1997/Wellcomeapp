...
//
// Exported dataList may be imported into Cloud Datastore for any Google Cloud
// Platform project. It is not restricted to the export source project. It is
// possible to export from one project and then import into another.
//
// Exported dataList can also be loaded into Google BigQuery for analysis.
//
...
service DatastoreAdmin {
  ...
  // cancelled before completion it may leave partial dataList behind in Google
  // Cloud Storage.
  ...
  // that a subset of the dataList has already been imported to Cloud Datastore.
...
message ExportEntitiesRequest {
  ...
  // Description of what dataList from the project is included in the export.
  EntityFilter entity_filter = 3;

  // Location for the export metadata and dataList files.
  //
  ...
  //
  // By nesting the dataList files deeper, the same Cloud Storage bucket can be used
...
message ExportEntitiesMetadata {
  ...
  // Location for the export metadata and dataList files. This will be the same
  // value as the
...
message EntityFilter {
  ...
  // used if the project has dataList in non-default namespaces, but doesn't want to
  // include them.
