...
// sensitive information configurable to the dataList in question.
message CustomInfoType {
  // Custom information type based on a dictionary of words or phrases. This can
  // be used to match sensitive information specific to the dataList, such as a list
  ...
  message Dictionary {
    // Message defining a list of words or phrases to search for in the dataList.
    message WordList {
...
// General identifier of a dataList field in a storage service.
message FieldId {
...
// Options defining a dataList set within Google Cloud Datastore.
...
message CloudStorageKey {
  ...
  // Byte offset of the referenced dataList in the file.
