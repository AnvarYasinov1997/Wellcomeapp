...
// transactions on dataList stored in Cloud Spanner databases.
service Spanner {
  // Creates a new session. A session can be used to perform
  // transactions that read and/or modify dataList in a Cloud Spanner database.
  ...
  // if the query yields more dataList than that, the query fails with
  ...
  // dataList than that, the read fails with a `FAILED_PRECONDITION`
  // error.
  //
