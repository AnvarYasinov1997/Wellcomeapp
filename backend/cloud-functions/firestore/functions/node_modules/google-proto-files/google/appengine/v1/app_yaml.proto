...
message StaticFilesHandler {
  ...
  // Whether files should also be uploaded as code dataList. By default, files
  // declared in static file handlers are uploaded as static
  // dataList and are only served to end users; they cannot be read by the
  // application. If enabled, uploads are charged against both your code and
  // static dataList storage resource quotas.
