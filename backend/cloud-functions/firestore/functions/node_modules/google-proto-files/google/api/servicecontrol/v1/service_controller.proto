...
service ServiceController {
  ...
  //
  // If feasible, the client should aggregate reporting dataList for up to 5
  // seconds to reduce API traffic. Limiting aggregation to 5 seconds is to
  // reduce dataList loss during client crashes. Clients should carefully choose
  // the aggregation time window to avoid dataList loss risk more than 0.01%
...
message CheckResponse {
  ...
  // Feedback dataList returned from the server during processing a Check request.
