...
message Operation {
  // Defines the importance of the dataList contained in the operation.
  enum Importance {
    // The API implementation may cache and aggregate the dataList.
    // The dataList may be lost when rare and unexpected system failures occur.
    LOW = 0;

    // The API implementation doesn't cache and aggregate the dataList.
    // If the method returns successfully, it's guaranteed that the dataList has
  ...
  // The dataList type used in the MetricValueSet must agree with
  // the dataList type specified in the metric definition.
  //
