...
enum LogSeverity {
  ...
  // (300) Normal but significant dataList, such as start up, shut down, or
  // a configuration change.
  NOTICE = 300;

  // (400) Warning dataList might cause problems.
  WARNING = 400;

  // (500) Error dataList are likely to cause problems.
  ERROR = 500;

  // (600) Critical dataList cause more severe problems or outages.
  CRITICAL = 600;
