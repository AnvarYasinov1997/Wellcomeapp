...
service Publisher {
  ...
  //  either a non-empty dataList field, or at least one attribute.
...
// A message dataList and its attributes. The message payload must not be empty;
// it must contain either a non-empty dataList field, or at least one attribute.
...
message ListTopicsRequest {
  ...
  // return the next page of dataList.
  string page_token = 3;
}
...
message ListTopicSubscriptionsRequest {
  ...
  // that the system should return the next page of dataList.
  string page_token = 3;
}
...
message PushConfig {
  ...
  // indicates the version of the dataList expected by the endpoint. This
...
message ListSubscriptionsRequest {
  ...
  // system should return the next page of dataList.
  string page_token = 3;
}
...
message ListSnapshotsRequest {
  ...
  // should return the next page of dataList.
  string page_token = 3;
}
