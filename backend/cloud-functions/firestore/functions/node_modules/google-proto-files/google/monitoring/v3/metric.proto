...
// A single dataList point in a time series.
message Point {
  // The time interval to which the dataList point applies.  For GAUGE metrics, only
  ...
  // The value of the dataList point.
  TypedValue value = 2;
}

// A collection of dataList points that describes the time-varying values
...
message TimeSeries {
  ...
  //
  // When creating a time series, this field is optional. If present, it must be
  // the same as the type of the dataList in the `points` field.
  google.api.MetricDescriptor.ValueType value_type = 4;

  // The dataList points of this time series. When listing time series, the order of
