...
service MetricService {
  ...
  // Creates or adds dataList to one or more time series.
...
message ListTimeSeriesRequest {
  ...
  enum TimeSeriesView {
    ...
    // and the time series dataList.
    FULL = 0;

    // Returns the identity of the metric and the time series resource,
    // but not the time series dataList.
    HEADERS = 1;
  }
  ...
  // that contain dataList points in the specified interval are included
  // in the response.
  TimeInterval interval = 4;

  // By default, the raw time series dataList is returned.
  // Use this field to combine multiple time series for different
  // views of the dataList.
...
message CreateTimeSeriesRequest {
  ...
  // The new dataList to be added to a list of time series.
  // Adds at most one dataList point to each of several time series.  The new dataList
...
// Describes the result of a failed request to write dataList to a time series.
