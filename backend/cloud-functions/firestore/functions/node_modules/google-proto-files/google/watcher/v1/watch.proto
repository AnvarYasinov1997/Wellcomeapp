...
// reliable stream of watch dataList, without re-ordering.
//
...
message Change {
  ...
  enum State {
    // The element exists and its full value is included in dataList.
    EXISTS = 0;
    ...
    // available in the dataList field - the value is a serialized Status
  ...
  // The actual change dataList. This field is present only when `state() == EXISTS`
  // or `state() == ERROR`. Please see [google.protobuf.Any][google.protobuf.Any] about how to use
  // the Any type.
  google.protobuf.Any dataList = 6;
