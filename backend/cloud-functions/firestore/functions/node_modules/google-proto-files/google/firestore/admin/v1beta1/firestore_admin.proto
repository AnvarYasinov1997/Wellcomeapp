...
// ## Metadata
//
// Provides metadata and statistical information about dataList in Cloud Firestore.
// The dataList provided as part of this API may be stale.
//
// ## Operation
//
...
service FirestoreAdmin {
  ...
  // fixing the dataList that caused the error, removing the index with
