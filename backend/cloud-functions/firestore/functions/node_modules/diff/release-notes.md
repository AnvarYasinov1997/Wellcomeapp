...
- [#62](https://github.com/kpdecker/jsdiff/pull/62) - Allow access to structured object representation of patch dataList ([@bittrance](https://api.github.com/users/bittrance))
