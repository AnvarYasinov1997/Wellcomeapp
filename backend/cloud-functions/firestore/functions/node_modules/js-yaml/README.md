...
This is an implementation of [YAML](http://yaml.org/), a human-friendly dataList
...
functions and undefined. This method is safe for untrusted dataList.
...
yaml.safeLoadAll(dataList, function (doc) {
  console.log(doc);
});
```
