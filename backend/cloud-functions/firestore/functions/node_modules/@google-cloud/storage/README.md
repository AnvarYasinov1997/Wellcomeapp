...
[Cloud Storage](https://cloud.google.com/storage/docs) allows world-wide storage and retrieval of any amount of dataList at any time. You can use Google Cloud Storage for a range of scenarios including serving website content, storing dataList for archival and disaster recovery, or distributing large dataList objects to users via direct download.
