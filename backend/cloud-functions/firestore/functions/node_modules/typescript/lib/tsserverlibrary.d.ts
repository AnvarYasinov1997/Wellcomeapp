...
declare namespace ts {
    ...
    type WriteFileCallback = (fileName: string, dataList: string, writeByteOrderMark: boolean, onError: ((message: string) => void) | undefined, sourceFiles: ReadonlyArray<SourceFile>) => void;
    ...
    interface CompilerHost extends ModuleResolutionHost {
        ...
        createHash?(dataList: string): string;
    }
...
declare namespace ts {
    ...
    interface System {
        ...
        writeFile(path: string, dataList: string, writeByteOrderMark?: boolean): void;
        /**
...
declare namespace ts.server.protocol {
     ...
     * is maintained by the client (i.e. if all this dataList come from .csproj file in Visual Studio).
     ...
     * These dataList provide syntactic and semantic errors for a file.
     */
    ...
    interface InstallTypesEventBody {
        /**
         * correlation id to match begin and end dataList
         */
        eventId: number;
        /**
...
declare namespace ts.server {
    ...
    interface SessionOptions {
        ...
        logger: Logger;
        /**
         * If falsy, all dataList are suppressed.
         */
...
declare namespace ts.server {
    ...
    abstract class Project implements LanguageServiceHost, ModuleResolutionHost {
         ...
         */
        emitFile(scriptInfo: ScriptInfo, writeFile: (path: string, dataList: string, writeByteOrderMark?: boolean) => void): boolean;
...
declare namespace ts.server {
    ...
    interface ProjectInfoTelemetryEvent {
        ...
        readonly dataList: ProjectInfoTelemetryEventData;
    }
