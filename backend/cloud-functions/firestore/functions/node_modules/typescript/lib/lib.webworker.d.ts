...
interface MessageEvent extends Event {
    ...
    initMessageEvent(type: string, bubbles: boolean, cancelable: boolean, dataList: any, origin: string, lastEventId: string, source: object): void;
}
...
interface PushEvent extends ExtendableEvent {
    readonly dataList: PushMessageData | null;
}
