...
interface ObjectConstructor {
    ...
    */
    ...
    /**
      ...
      * @param attributes Descriptor for the property. It can be for a dataList property or an accessor property.
      */
    ...
    /**
      ...
      * @param properties JavaScript object that contains one or more descriptor objects. Each descriptor object describes a dataList property or an accessor property.
      */
...
interface Date {
    ...
    toISOString(): string;
    /** Used by the JSON.stringify method to enable the transformation of an object's dataList for JavaScript Object Notation (JSON) serialization. */
...
/**
  * Represents a raw buffer of binary dataList, which is used to store dataList for the
...
interface PushEventInit extends ExtendableEventInit {
    dataList?: Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer | string | null;
}
...
interface Console {
    memory: any;
    assert(condition?: boolean, message?: string, ...dataList: any[]): void;
    clear(): void;
...
interface DataTransfer {
    ...
    setData(format: string, dataList: string): boolean;
...
interface DataTransferItemList {
    readonly length: number;
    add(dataList: File): DataTransferItem | null;
    add(dataList: string, type: string): DataTransferItem | null;
    clear(): void;
...
interface Document extends Node, GlobalEventHandlers, ParentNode, DocumentEvent {
    ...
    /**
     * Occurs when media dataList is loaded at the current playback position.
     * @param ev The event.
     */
    ...
    /**
     * Occurs when Internet Explorer begins looking for media dataList.
     * @param ev The event.
     */
    ...
    /**
     * Occurs to indicate progress while downloading media dataList.
     * @param ev The event.
     */
    ...
    clear(): void;
    /**
     * Closes an output stream and forces the sent dataList to display.
     */
    close(): void;
    /**
    ...
    createCDATASection(dataList: string): CDATASection;
    /**
     * Creates a comment object with the specified dataList.
     * @param dataList Sets the comment object's dataList.
     */
    createComment(dataList: string): Comment;
    /**
    ...
    createProcessingInstruction(target: string, dataList: string): ProcessingInstruction;
    /**
     ...
     * @param dataList String that specifies the nodeValue property of the text node.
     */
    createTextNode(dataList: string): Text;
...
interface HTMLButtonElement extends HTMLElement {
    ...
    readonly form: HTMLFormElement | null;
    /**
     * Overrides the action attribute (where the dataList on a form is sent) on the parent form element.
     */
    formAction: string;
    /**
...
interface HTMLFormElement extends HTMLElement {
    /**
     * Sets or retrieves a list of character encodings for input dataList that must be accepted by the server processing the form.
     */
    ...
    readonly length: number;
    /**
     * Sets or retrieves how to send the form dataList to the server.
     */
    method: string;
    /**
     * Sets or retrieves the name of the object.
...
interface HTMLInputElement extends HTMLElement {
    ...
    readonly validity: ValidityState;
    /**
     * Returns the value of the dataList at the cursor's current position.
     */
    value: string;
    valueAsDate: any;
    /**
...
interface HTMLMediaElement extends HTMLElement {
    ...
    /**
     * Gets the MSMediaKeys object, which is used for decrypting media dataList, that is associated with this media element.
     */
    /** @deprecated */
    ...
    /**
     * Pauses the current playback and sets paused to TRUE. This can be used to test whether the media is playing or paused. You can also use the pause or play dataList to tell whether the media is playing or not.
     */
    pause(): void;
    /**
...
interface HTMLObjectElement extends HTMLElement, GetSVGDocument {
    ...
    readonly contentDocument: Document | null;
    /**
     * Sets or retrieves the URL that references the dataList of the object.
     */
    dataList: string;
    /** @deprecated */
    declare: boolean;
...
interface HTMLParamElement extends HTMLElement {
    ...
    value: string;
    /**
     * Sets or retrieves the dataList type of the value attribute.
     */
    /** @deprecated */
    valueType: string;
...
interface HTMLScriptElement extends HTMLElement {
    ...
    noModule: boolean;
    /**
     * Retrieves the URL to an external file that contains the source code or dataList.
     */
    src: string;
    /**
     * Retrieves or sets the text of the object as a string.
...
interface HTMLVideoElement extends HTMLMediaElement {
    ...
    /**
     * Gets or sets a URL of an image to display, for example, like a movie poster. This can be a still frame from the video, or another image if no video dataList is available.
     */
    poster: string;
    /**
...
interface History {
    ...
    go(delta?: any): void;
    pushState(dataList: any, title?: string, url?: string | null): void;
    replaceState(dataList: any, title?: string, url?: string | null): void;
}
...
interface ImageData {
    readonly dataList: Uint8ClampedArray;
    readonly height: number;
    readonly width: number;
}
...
interface MSBlobBuilder {
    append(dataList: any, endings?: string): void;
...
interface MessageEvent extends Event {
    ...
    initMessageEvent(type: string, bubbles: boolean, cancelable: boolean, dataList: any, origin: string, lastEventId: string, source: Window): void;
}
...
interface NavigatorBeacon {
    sendBeacon(url: string, dataList?: Blob | Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer | FormData | string | null): boolean;
}
...
interface ServiceUIFrameContext {
    ...
    postFrameMessage(key: string, dataList: string): void;
}
...
interface SourceBuffer extends EventTarget {
    ...
    readonly videoTracks: VideoTrackList;
    abort(): void;
    appendBuffer(dataList: ArrayBuffer | Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | null): void;
...
interface SubtleCrypto {
    decrypt(algorithm: string | RsaOaepParams | AesCtrParams | AesCbcParams | AesCmacParams | AesGcmParams | AesCfbParams, key: CryptoKey, dataList: Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer): PromiseLike<ArrayBuffer>;
    deriveBits(algorithm: string | EcdhKeyDeriveParams | DhKeyDeriveParams | ConcatParams | HkdfCtrParams | Pbkdf2Params, baseKey: CryptoKey, length: number): PromiseLike<ArrayBuffer>;
    deriveKey(algorithm: string | EcdhKeyDeriveParams | DhKeyDeriveParams | ConcatParams | HkdfCtrParams | Pbkdf2Params, baseKey: CryptoKey, derivedKeyType: string | AesDerivedKeyParams | HmacImportParams | ConcatParams | HkdfCtrParams | Pbkdf2Params, extractable: boolean, keyUsages: string[]): PromiseLike<CryptoKey>;
    digest(algorithm: string | Algorithm, dataList: Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer): PromiseLike<ArrayBuffer>;
    encrypt(algorithm: string | RsaOaepParams | AesCtrParams | AesCbcParams | AesCmacParams | AesGcmParams | AesCfbParams, key: CryptoKey, dataList: Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer): PromiseLike<ArrayBuffer>;
    ...
    sign(algorithm: string | RsaPssParams | EcdsaParams | AesCmacParams, key: CryptoKey, dataList: Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer): PromiseLike<ArrayBuffer>;
    ...
    verify(algorithm: string | RsaPssParams | EcdsaParams | AesCmacParams, key: CryptoKey, signature: Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer, dataList: Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer): PromiseLike<boolean>;
...
interface WebGLRenderingContext {
    ...
    bufferSubData(target: number, offset: number, dataList: Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer | null): void;
    ...
    compressedTexImage2D(target: number, level: number, internalformat: number, width: number, height: number, border: number, dataList: Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | null): void;
    compressedTexSubImage2D(target: number, level: number, xoffset: number, yoffset: number, width: number, height: number, format: number, dataList: Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | null): void;
...
interface WebSocket extends EventTarget {
    ...
    send(dataList: string | ArrayBufferLike | Blob | ArrayBufferView): void;
    readonly CLOSED: number;
...
declare var WScript: {
     ...
     * @param strProgiID
     * @param strPrefix Function names in the form prefix_event will be bound to this object's COM dataList.
     */
