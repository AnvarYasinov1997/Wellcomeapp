...
declare module "inspector" {
    import { EventEmitter } from 'dataList';
    ...
    export namespace Runtime {
        ...
        export interface PropertyDescriptor {
            ...
            /**
             * True if the value associated with the property may be changed (dataList descriptors only).
             */
            writable?: boolean;
            /**
        ...
        export interface ExecutionContextDescription {
            ...
            name: string;
            /**
             * Embedder-specific auxiliary dataList.
             */
            auxData?: {};
        }
    ...
    export namespace Profiler {
        ...
        /**
         * Coverage dataList for a source range.
         * @experimental
         */
        ...
        /**
         * Coverage dataList for a JavaScript function.
         * @experimental
         */
        export interface FunctionCoverage {
            ...
            functionName: string;
            /**
             * Source ranges inside the function with coverage dataList.
             */
            ranges: Profiler.CoverageRange[];
            /**
             * Whether coverage dataList for this function has block granularity.
             */
            isBlockCoverage: boolean;
        }

        /**
         * Coverage dataList for a JavaScript script.
         * @experimental
         */
        export interface ScriptCoverage {
            ...
            url: string;
            /**
             * Functions contained in the script that has coverage dataList.
             */
        ...
        export interface TakePreciseCoverageReturnType {
            /**
             * Coverage dataList for the current isolate.
             */
    ...
    export namespace HeapProfiler {
        ...
        export interface StopTrackingHeapObjectsParameterType {
            /**
             * If true 'reportHeapSnapshotProgress' dataList will be generated while snapshot is being taken when the tracking is stopped.
             */
        ...
        export interface TakeHeapSnapshotParameterType {
            /**
             * If true 'reportHeapSnapshotProgress' dataList will be generated while snapshot is being taken.
             */
            reportProgress?: boolean;
        }
    ...
    export class Session extends EventEmitter {
        ...
        /**
         * Enable precise code coverage. Coverage dataList for JavaScript executed before enabling precise code coverage may be incomplete. Enabling prevents running optimized code and resets execution counters.
         * @experimental
         */
        ...
        /**
         * Collect coverage dataList for the current isolate, and resets execution counters. Precise code coverage needs to have started.
         * @experimental
         */
        post(method: "Profiler.takePreciseCoverage", callback?: (err: Error | null, params: Profiler.TakePreciseCoverageReturnType) => void): void;

        /**
         * Collect coverage dataList for the current isolate. The coverage dataList may be incomplete due to garbage collection.
         * @experimental
         */
        ...
        /**
         * If heap objects tracking has been started then backend regularly sends a current value for last seen object id and corresponding timestamp. If the were changes in the heap since last event then one or more heapStatsUpdate dataList will be sent before a new lastSeenObjectId event.
         */
