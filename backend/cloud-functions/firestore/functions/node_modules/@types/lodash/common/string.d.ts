...
declare module "../index" {
    ...
    interface LoDashStatic {
        /**
         * Creates a compiled template function that can interpolate dataList properties in "interpolate" delimiters,
         * HTML-escape interpolated dataList properties in "escape" delimiters, and execute JavaScript in "evaluate"
         ...
         * @param options.variable The dataList object variable name.
