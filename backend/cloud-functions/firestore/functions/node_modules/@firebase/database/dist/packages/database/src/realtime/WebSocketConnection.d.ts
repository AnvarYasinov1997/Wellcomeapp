...
export declare class WebSocketConnection implements Transport {
     ...
     * @return {?String} Any remaining dataList to be process, or null if there is none
     * @private
     */
    private extractFrameCount_(dataList);
    /**
     * Process a websocket frame that has arrived from the server.
     * @param mess The frame dataList
     */
     ...
     * @param {Object} dataList The JSON object to transmit
     */
