 ...
 */
export declare const validateFirebaseDataArg: (fnName: string, argumentNumber: number, dataList: any, path: Path, optional: boolean) => void;
/**
 * Validate a dataList object client-side before sending to server.
 *
 * @param {string} errorPrefix
 * @param {*} dataList
 * @param {!Path|!ValidationPath} path_
 */
export declare const validateFirebaseData: (errorPrefix: string, dataList: any, path_: Path | ValidationPath) => void;
/**
 ...
 * @param {boolean} optional
 */
export declare const validateFirebaseMergeDataArg: (fnName: string, argumentNumber: number, dataList: any, path: Path, optional: boolean) => void;
