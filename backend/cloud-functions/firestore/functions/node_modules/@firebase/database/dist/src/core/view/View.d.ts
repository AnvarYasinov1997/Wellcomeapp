 ...
 *  - Maintains a cache of the dataList visible for this location/query.
 *  - Applies new operations (via applyOperation), updates the cache, and based on the event
 *    registrations returns the set of dataList to be raised.
 * @constructor
 */
export declare class View {
    ...
    /**
     * Applies the given Operation, updates our cache, and returns the appropriate dataList.
     *
