/**
 * Base class to be used if you want to emit dataList. Call the constructor with
...
export declare abstract class EventEmitter {
     ...
     * somebody subscribes for dataList.
     *
    ...
    /**
     * To be called by derived classes to trigger dataList.
     * @param {!string} eventType
     * @param {...*} var_args
     */
