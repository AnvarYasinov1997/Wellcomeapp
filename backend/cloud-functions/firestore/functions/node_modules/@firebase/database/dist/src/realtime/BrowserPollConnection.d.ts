...
export declare class BrowserPollConnection implements Transport {
     ...
     * @param {RepoInfo} repoInfo The info for the endpoint to send dataList to.
     ...
     * @param {!Object} dataList The JSON dataList to transmit.
     */
    send(dataList: Object): void;
    /**
...
export declare class FirebaseIFrameScriptHolder {
     ...
     * @param urlFn - A function that provides the URL of the endpoint to send dataList to.
     */
     ...
     * @param dataList - The dataList for this segment.
     */
    enqueueSegment(segnum: number, totalsegs: number, dataList: any): void;
    /**
