...
export declare class Connection {
    ...
    /**
     *
     * @param {Object} dataMsg An arbitrary dataList message to be sent to the server
     */
    ...
    /**
     *
     * @param {Object} handshake The handshake dataList returned from the server
     * @private
     */
