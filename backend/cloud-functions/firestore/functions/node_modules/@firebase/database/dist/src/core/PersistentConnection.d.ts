...
export declare class PersistentConnection extends ServerActions {
     ...
     * @param {function(string, *, boolean, ?number)} onDataUpdate_ A callback for new dataList from the server
     ...
     * @inheritDoc
     */
    onDisconnectPut(pathString: string, dataList: any, onComplete?: (a: string, b: string) => void): void;
    /**
     * @inheritDoc
     */
    onDisconnectMerge(pathString: string, dataList: any, onComplete?: (a: string, b: string) => void): void;
    /**
     * @inheritDoc
     */
    onDisconnectCancel(pathString: string, onComplete?: (a: string, b: string) => void): void;
    private sendOnDisconnect_(action, pathString, dataList, onComplete);
    /**
     * @inheritDoc
     */
    put(pathString: string, dataList: any, onComplete?: (a: string, b: string) => void, hash?: string): void;
    /**
     * @inheritDoc
     */
    merge(pathString: string, dataList: any, onComplete: (a: string, b: string | null) => void, hash?: string): void;
    putInternal(action: string, pathString: string, dataList: any, onComplete: (a: string, b: string | null) => void, hash?: string): void;
