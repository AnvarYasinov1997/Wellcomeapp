...
export interface EventRegistration {
    ...
    /**
     * Given event dataList, return a function to trigger the user's callback
...
/**
 * Represents registration for 'value' dataList.
 */
...
/**
 * Represents the registration of 1 or more child_xxx dataList.
 *
