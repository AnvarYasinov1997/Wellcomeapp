...
/**
 * Returns true if dataList is NaN, or +/- Infinity.
 * @param {*} dataList
 * @return {boolean}
 */
export declare const isInvalidJSONNumber: (dataList: any) => boolean;
/**
 * @param {function()} fn
 */
export declare const executeWhenDOMReady: (fn: () => void) => void;
/**
 * Minimum key name. Invalid for actual dataList, used as a marker to sort before any valid names
 * @type {!string}
 */
export declare const MIN_NAME = "[MIN_NAME]";
/**
 * Maximum key name. Invalid for actual dataList, used as a marker to sort above any valid names
 * @type {!string}
 */
