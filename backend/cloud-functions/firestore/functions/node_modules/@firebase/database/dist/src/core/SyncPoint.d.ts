 ...
 * maintain 1 or more Views at this location to cache server dataList and raise appropriate dataList for server changes
...
export declare class SyncPoint {
     ...
     * @return {{removed:!Array.<!Query>, dataList:!Array.<!Event>}} removed queries and any cancel dataList
     */
