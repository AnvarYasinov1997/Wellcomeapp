...
/**
 * Encapsulates the dataList needed to raise an event
 * @interface
 */
...
export declare class DataEvent implements Event {
     ...
     * @param {!EventRegistration} eventRegistration The function to call to with the event dataList. User provided
     * @param {!DataSnapshot} snapshot The dataList backing the event
     * @param {?string=} prevName Optional, the name of the previous child for child_* dataList.
     */
