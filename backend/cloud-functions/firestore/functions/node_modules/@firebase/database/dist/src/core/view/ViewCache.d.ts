...
/**
 * Stores the dataList we have cached for a view.
 *
 * serverSnap is the cached server dataList, eventSnap is the cached event dataList (server dataList plus any local writes).
 *
 * @constructor
 */
