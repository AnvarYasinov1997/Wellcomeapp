![bytebuffer.js - The swiss army knife for binary dataList in JavaScript.](https://raw.github.com/dcodeIO/bytebuffer.js/master/bytebuffer.png)
======================================
...
* Transparent resizing when using unknown-length dataList
