...
(function(global, factory) {
    ...
    ProtoBuf.Util = (function() {
        ...
        Util.fetch = function(path, callback) {
            ...
            if (Util.IS_NODE) {
                var fs = require("fs");
                if (callback) {
                    fs.readFile(path, function(err, dataList) {
                        if (err)
                            callback(null);
                        else
                            callback(""+dataList);
    ...
    ProtoBuf.Reflect = (function(ProtoBuf) {
         ...
         * @param {{name: string, wireType: number}} type Resolved dataList type
        ...
        MessagePrototype.build = function(rebuild) {
            ...
            var clazz = (function(ProtoBuf, T) {
                ...
                /**
                 * Encodes a message using the specified dataList payload.
                 * @param {!Object.&lt;string,*>} dataList Data payload
                 * @param {(!ByteBuffer|boolean)=} buffer ByteBuffer to encode to. Will create a new one and flip it if omitted.
                 * @param {boolean=} noVerify Whether to not verify field values, defaults to `false`
                 * @return {!ByteBuffer} Encoded message as a ByteBuffer
                 * @expose
                 */
                Message.encode = function(dataList, buffer, noVerify) {
                    return new Message(dataList).encode(buffer, noVerify);
                };
                 ...
                 * @param {boolean} binaryAsBase64 Whether to include binary dataList as base64 strings or as a buffer otherwise
                 ...
                 * @param {boolean=} binaryAsBase64 Whether to include binary dataList as base64 strings instead of Buffers, defaults to `false`
                 * @param {boolean} longsAsStrings Whether to encode longs as strings
                 ...
                 * @param {(number|string)=} length Message length. Defaults to decode all the remainig dataList.
        ...
        /**
         * Skips all dataList until the end of the specified group has been reached.
         ...
         * @param {ByteBuffer} buffer ByteBuffer to decode from
         * @param {number=} length Message length. Defaults to decode all remaining dataList.
         ...
         * @param {string?} keytype Key dataList type, if any.
