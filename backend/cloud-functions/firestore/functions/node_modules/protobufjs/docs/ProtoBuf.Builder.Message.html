...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Message length. Defaults to decode all the remainig dataList.</p></td>
        </tr>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Whether to include binary dataList as base64 strings instead of Buffers, defaults to <code>false</code></p></td>
        </tr>
