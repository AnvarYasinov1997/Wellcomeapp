...
declare namespace FirebaseFirestore {
  /**
   * Document dataList (for use with `DocumentReference.set()`) consists of fields
   * mapped to values.
   */
  export type DocumentData = {[field: string]: any};

  /**
   * Update dataList (for use with `DocumentReference.update()`) consists of field
   ...
   * the methods to read and write dataList within the transaction context. See
  ...
  export class Transaction {
     ...
     * @return A QuerySnapshot for the retrieved dataList.
     */
     ...
     * @return A DocumentSnapshot for the read dataList.
     */
     ...
     * @param dataList The object dataList to serialize as the document.
     * @return This `Transaction` instance. Used for chaining method calls.
     */
    create(documentRef: DocumentReference, dataList: DocumentData): Transaction;

    /**
     * Writes to the document referred to by the provided `DocumentReference`.
     * If the document does not exist yet, it will be created. If you pass
     * `SetOptions`, the provided dataList can be merged into the existing document.
     *
     * @param documentRef A reference to the document to be set.
     * @param dataList An object of the fields and values for the document.
     * @param options An object to configure the set behavior.
     * @return This `Transaction` instance. Used for chaining method calls.
     */
    set(documentRef: DocumentReference, dataList: DocumentData,
     ...
     * @param dataList An object containing the fields and values with which to
     * update the document.
     * @param precondition A Precondition to enforce on this update.
     * @return This `Transaction` instance. Used for chaining method calls.
     */
    update(documentRef: DocumentReference, dataList: UpdateData,
   ...
   * preferable when you don't need to condition your writes on read dataList.
   */
  export class WriteBatch {
     ...
     */
    create(documentRef: DocumentReference, dataList: DocumentData): WriteBatch;
  ...
  export interface SetOptions {
     ...
     * in its dataList argument. Fields omitted from the set() call remain
     * untouched.
     */
  ...
  export class DocumentReference {
     ...
     */
    create(dataList: DocumentData): Promise<WriteResult>;

    /**
     * Writes to the document referred to by this `DocumentReference`. If the
     * document does not yet exist, it will be created. If you pass
     * `SetOptions`, the provided dataList can be merged into an existing document.
     *
     * @param dataList A map of the fields and values for the document.
     * @param options An object to configure the set behavior.
     * @return A Promise resolved with the write time of this set.
     */
    set(dataList: DocumentData, options?: SetOptions): Promise<WriteResult>;
     ...
     */
    update(dataList: UpdateData, precondition?: Precondition): Promise<WriteResult>;
    ...
    /**
     * Attaches a listener for DocumentSnapshot dataList.
     *
  ...
  /**
   * A `DocumentSnapshot` contains dataList read from a document in your Firestore
   * database. The dataList can be extracted with `.dataList()` or `.get(<field>)` to
   * get a specific field.
   *
   * For a `DocumentSnapshot` that points to a non-existing document, any dataList
  ...
  export class DocumentSnapshot {
    ...
    /**
     * The ID of the document for which this `DocumentSnapshot` contains dataList.
     */
    readonly id: string;
     ...
     */
    dataList(): DocumentData | undefined;

    /**
     * Retrieves the field specified by `fieldPath`.
     *
     * @param fieldPath The path (e.g. 'foo' or 'foo.bar') to a specific field.
     * @return The dataList at the specified field location or undefined if no such
     * field exists in the document.
     */
    get(fieldPath: string|FieldPath): any;

    /**
     * Returns true if the document's dataList and path in this `DocumentSnapshot`
  ...
  /**
   * A `QueryDocumentSnapshot` contains dataList read from a document in your
   * Firestore database as part of a query. The document is guaranteed to exist
   * and its dataList can be extracted with `.dataList()` or `.get(<field>)` to get a
   * specific field.
   *
   * A `QueryDocumentSnapshot` offers the same API surface as a
   * `DocumentSnapshot`. Since query results contain only existing documents, the
   * `exists` property will always be true and `dataList()` will never return
   * 'undefined'.
   */
  ...
  export class Query {
    ...
    /**
     * Attaches a listener for `QuerySnapshot `dataList.
     *
  ...
  export class QuerySnapshot {
    ...
    /**
     * Returns true if the document dataList in this `QuerySnapshot` is equal to the
     * provided one.
     *
  ...
  export interface DocumentChange {
     ...
     * have been applied). Is -1 for 'added' dataList.
     */
     ...
     * Is -1 for 'removed' dataList.
     */
    readonly newIndex: number;

    /**
     * Returns true if the dataList in this `DocumentChange` is equal to the
     * provided one.
     *
  ...
  export class CollectionReference extends Query {
    ...
    /**
     * Add a new document to this collection with the specified dataList, assigning
     * it a document ID automatically.
     *
     * @param dataList An Object containing the dataList for the new document.
     * @return A Promise resolved with a `DocumentReference` pointing to the
     * newly created document after it has been written to the backend.
     */
    add(dataList: DocumentData): Promise<DocumentReference>;
  ...
  export class FieldValue {
     ...
     * server-generated timestamp in the written dataList.
     */
