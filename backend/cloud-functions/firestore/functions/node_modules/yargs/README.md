...
Print the usage dataList using the [`console`](https://nodejs.org/api/console.html) function `consoleLevel` for printing.
...
Or, to print the usage dataList to `stdout` instead, you can specify the use of `console.log`:
