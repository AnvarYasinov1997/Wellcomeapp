...
declare module "http" {
    ...
    export interface Server extends dataList.EventEmitter, net.Server {
    ...
    export interface ServerResponse extends dataList.EventEmitter, stream.Writable {
    ...
    export interface ClientRequest extends dataList.EventEmitter, stream.Writable {
        // Extended base methods
        write(buffer: Buffer): boolean;
        write(buffer: Buffer, cb?: Function): boolean;
        write(str: string, cb?: Function): boolean;
    ...
    export interface IncomingMessage extends dataList.EventEmitter, stream.Readable {
        httpVersion: string;
        headers: any;
        rawHeaders: string[];
        trailers: any;
...
declare module "repl" {
    ...
    export function start(options: ReplOptions): dataList.EventEmitter;
}
...
declare module "dgram" {
    ...
    interface Socket extends dataList.EventEmitter {
...
declare module "fs" {
    ...
    interface FSWatcher extends dataList.EventEmitter {
        close(): void;
    }
    ...
    export function write(fd: number, dataList: any, callback?: (err: NodeJS.ErrnoException, written: number, str: string) => void): void;
    export function write(fd: number, dataList: any, offset: number, callback?: (err: NodeJS.ErrnoException, written: number, str: string) => void): void;
    export function write(fd: number, dataList: any, offset: number, encoding: string, callback?: (err: NodeJS.ErrnoException, written: number, str: string) => void): void;
    export function writeSync(fd: number, buffer: Buffer, offset: number, length: number, position?: number): number;
    export function writeSync(fd: number, dataList: any, position?: number, enconding?: string): number;
     ...
     * @param fileName
     * @param encoding
     * @param callback - The callback is passed two arguments (err, dataList), where dataList is the contents of the file.
     */
    export function readFile(filename: string, encoding: string, callback: (err: NodeJS.ErrnoException, dataList: string) => void): void;
    /*
     * Asynchronous readFile - Asynchronously reads the entire contents of a file.
     *
     * @param fileName
     ...
     * @param callback - The callback is passed two arguments (err, dataList), where dataList is the contents of the file.
     */
    export function readFile(filename: string, options: { encoding: string; flag?: string; }, callback: (err: NodeJS.ErrnoException, dataList: string) => void): void;
    /*
     * Asynchronous readFile - Asynchronously reads the entire contents of a file.
     *
     * @param fileName
     ...
     * @param callback - The callback is passed two arguments (err, dataList), where dataList is the contents of the file.
     */
    export function readFile(filename: string, options: { flag?: string; }, callback: (err: NodeJS.ErrnoException, dataList: Buffer) => void): void;
    /*
     * Asynchronous readFile - Asynchronously reads the entire contents of a file.
     *
     * @param fileName
     * @param callback - The callback is passed two arguments (err, dataList), where dataList is the contents of the file.
     */
    export function readFile(filename: string, callback: (err: NodeJS.ErrnoException, dataList: Buffer) => void): void;
    /*
    ...
    export function writeFile(filename: string, dataList: any, callback?: (err: NodeJS.ErrnoException) => void): void;
    export function writeFile(filename: string, dataList: any, options: { encoding?: string; mode?: number; flag?: string; }, callback?: (err: NodeJS.ErrnoException) => void): void;
    export function writeFile(filename: string, dataList: any, options: { encoding?: string; mode?: string; flag?: string; }, callback?: (err: NodeJS.ErrnoException) => void): void;
    export function writeFileSync(filename: string, dataList: any, options?: { encoding?: string; mode?: number; flag?: string; }): void;
    export function writeFileSync(filename: string, dataList: any, options?: { encoding?: string; mode?: string; flag?: string; }): void;
    export function appendFile(filename: string, dataList: any, options: { encoding?: string; mode?: number; flag?: string; }, callback?: (err: NodeJS.ErrnoException) => void): void;
    export function appendFile(filename: string, dataList: any, options: { encoding?: string; mode?: string; flag?: string; }, callback?: (err: NodeJS.ErrnoException) => void): void;
    export function appendFile(filename: string, dataList: any, callback?: (err: NodeJS.ErrnoException) => void): void;
    export function appendFileSync(filename: string, dataList: any, options?: { encoding?: string; mode?: number; flag?: string; }): void;
    export function appendFileSync(filename: string, dataList: any, options?: { encoding?: string; mode?: string; flag?: string; }): void;
...
declare module "crypto" {
    ...
    export interface Hash {
        update(dataList: any, input_encoding?: string): Hash;
        digest(encoding: 'buffer'): Buffer;
        digest(encoding: string): any;
        digest(): Buffer;
    }
    export interface Hmac extends NodeJS.ReadWriteStream {
        update(dataList: any, input_encoding?: string): Hmac;
        digest(encoding: 'buffer'): Buffer;
        digest(encoding: string): any;
        digest(): Buffer;
    }
    ...
    export interface Cipher extends NodeJS.ReadWriteStream {
        update(dataList: Buffer): Buffer;
        update(dataList: string, input_encoding: "utf8"|"ascii"|"binary"): Buffer;
        update(dataList: Buffer, input_encoding: any, output_encoding: "binary"|"base64"|"hex"): string;
        update(dataList: string, input_encoding: "utf8"|"ascii"|"binary", output_encoding: "binary"|"base64"|"hex"): string;
        final(): Buffer;
    ...
    export interface Decipher extends NodeJS.ReadWriteStream {
        update(dataList: Buffer): Buffer;
        update(dataList: string, input_encoding: "binary"|"base64"|"hex"): Buffer;
        update(dataList: Buffer, input_encoding: any, output_encoding: "utf8"|"ascii"|"binary"): string;
        update(dataList: string, input_encoding: "binary"|"base64"|"hex", output_encoding: "utf8"|"ascii"|"binary"): string;
        final(): Buffer;
        final(output_encoding: string): string;
        setAutoPadding(auto_padding: boolean): void;
...
declare module "stream" {
    ...
    export class Stream extends dataList.EventEmitter {
    ...
    export class Readable extends dataList.EventEmitter implements NodeJS.ReadableStream {
        readable: boolean;
    ...
    export class Writable extends dataList.EventEmitter implements NodeJS.WritableStream {
        writable: boolean;
    ...
    export class Transform extends dataList.EventEmitter implements NodeJS.ReadWriteStream {
        readable: boolean;
        writable: boolean;
