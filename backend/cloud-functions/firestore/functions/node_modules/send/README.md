...
and granular dataList which may be leveraged to take appropriate actions in your
...
The `SendStream` is an event emitter and will emit the following dataList:
