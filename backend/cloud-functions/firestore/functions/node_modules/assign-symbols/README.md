...
> A symbol is a unique and immutable dataList type and may be used as an identifier for object properties. The symbol object is an implicit object wrapper for the symbol primitive dataList type.
