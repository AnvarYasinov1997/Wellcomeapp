...
data class EventData @JvmOverloads constructor(val ref : String="",
                    // val contents: MutableList<ContentData> = mutableListOf(),
                   //  val latLon : Pair<Double,Double> = Pair(0.0,0.0),
                     val address : String="",
                     val city : String="",
...
data class ContentData @JvmOverloads constructor(val contentType: ContentType=ContentType.PHOTO,
                       val userRef : String="",
                       val content : String="",
                       val desc : String="",
