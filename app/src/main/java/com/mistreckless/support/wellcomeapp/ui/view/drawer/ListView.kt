...
class ListViewHolder(override var presenter: DrawerListPresenter, parent : ViewGroup?, baseRouter: BaseRouter)
    : BaseViewHolder<ListItem,DrawerListPresenter>(baseRouter,parent, R.layout.view_drawer_item), ListView{
